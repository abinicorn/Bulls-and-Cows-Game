...
![alt text](a03-first.PNG "Example Output 1")
...
To receive full marks for this assignment, you must show your design to one of your lectures / tutors before the end of week 7 for feedback on your design, and before the end of week 9 for the second feedback on your design and/or implementation. You then need to take the feedback into consideration - whether you are going to follow the suggestions or you are going with your original design. You must also update your repository with the initial implementation by the end of week 8. Failure to demonstrate your initial design and implementation will result in a mark of zero for this assignment.
...
![alt text](a03-fourth.PNG "Example Output 4")
